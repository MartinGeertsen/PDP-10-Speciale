...
Effect pedals is a normal piece of equipment used by guitarists and bassists, in many different music genres. An effect pedal works by changing the input signal from the instrument, accordingly to the effect type. This gives the musician the ability to change the sound of the his/hers instrument, with a simple stomp on a box on the floor. By using normal effect pedals, you're normally limited in the sense of only being able to adjust a small number of parameters on physical knobs on the pedal. A simple guitar pedal is shown on \autoref{fig:EffectPedalExample}. On this example there is three separately adjustable parameters on the pedal (Dwell, Mix and Tone), which each have its own knob. In 2011 however, TC Electronics decided to change the limit of adjustable parameters on their pedals.\\
TC Electronics did, in company with several professional and famous guitarists and bassists, create a new way of change the sound of a effect, by creating the TonePrint concept. The concepts is that TC Electronics makes a lot of .........
