...
\begin{itemize}
	\item Why it makes sense (Benefits of UCD)
	\item Describe the project proposal.
\begin{itemize}
	\item TC needs us to figure out how to involve users in their development process for the TonePrint Community.
\end{itemize}
	\item TC electronic, TonePrint and Community
\begin{itemize}
	\item Who is TC Electronic 
	\item What is the TonePrint concept and how does it work. 
	\item Describe the outlining scope of the TonePrint Community.
\end{itemize}
	\item The SCRUM framework
\begin{itemize}
	\item We know that TC uses the SCRUM framework and we therefor should describe it briefly.
\end{itemize}
\end{itemize}

\begin{itemize}
	\item Research question and problem statement
\begin{itemize}
	\item Specifying the problem and scope.
	\item Individual statements
...
\noindent
%Se Rop's rettelser. Der skal foretages nogle seriøse ændringer i denne sektion.
